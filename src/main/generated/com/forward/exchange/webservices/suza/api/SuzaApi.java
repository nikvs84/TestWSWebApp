...
public class SuzaApi extends com.forward.exchange.webservices.kit.DatabaseExchange {
   private final SuzaApiService delegate = SuzaApiServiceFactory.getSuzaApi();
    ...
    public Response createComment(@ApiParam(value = "" ,required=true) CreateComment createComment
...
,@Context ContainerRequestContext requestContext)
    ...
    public Response getLastComments(@ApiParam(value = "" ,required=true) GetLastComments getLastComments
,@Context ContainerRequestContext requestContext)
    {
    ...
    public Response getRequestComments(@ApiParam(value = "" ,required=true) GetRequestComments getRequestComments
,@Context ContainerRequestContext requestContext)
    {
